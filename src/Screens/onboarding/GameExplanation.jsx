    ...
    return (
      <section className="explanation">
        <div>
          ...
          <br />
          <p>
            As an admin, your main task it to conduct the game and decide when
            to start and stop the round. First, when you create the game
            essentials, you will get the links to conduct the game and to share
            it to fellow participants. After you have shared the link, click on{" "}
            <i>join the game</i> and log in with the credentials you have
            created.
          </p>
          <br />
          <p>
            ...
            When you start the round, the players would be able to play the
            game. After 20 seconds of starting the round you will get a
            notification to close the round. Thats when you should close the
            round and wait some seconds to start the next round.
          </p>
          <br />
          ...
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/9GH_AarysN4"
    ...
    return (
      <section className="explanation">
        <div>
          ...
          <br />
          <p>
            In order to win the game, you have to make the right choices and
            make the most amount of money at the end of the game.
          </p>
          <br />
          ...
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/EodLYrqbkng"
            title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowfullscreen
        ...
        <div>
          ...
          <h2>Play the Game</h2>
          <code style={{ fontFamily: "monospace" }}>
            Enter the room number of click the link sent by the conductor
          </code>
  ...
  return (
    <div className="screen">
      ...
      {role === "admin" ? (
        ...
        <PlayerExplanation storeData={storeData} />
      )}
    </div>
  );
}
