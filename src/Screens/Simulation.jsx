    ...
    <section className="screen">
      ...
      {Object.keys(userData).length === 0 ? (
        <div>
          ...
          <br />
          <code>
            You need to join a room before coming to the simulation room
          </code>
          ...
          {roundState ? (
            <div>
              ...
              <div className="user-details">
                ...
                <div>
                  <p className={counter < 6 && counter > 0 && "red-text"}>
                    {counter > 0
                      ? `Round ends in ${counter} seconds`
                      : "The round has ended"}
                  </p>
                </div>
              </div>
              ...
              {choices ? (
                <div className="choices">
                  <CareerCard
                    ...
                    name={choices[0].name}
                    id={choices[0].id}
                    changeChoice={onChangeChoice}
                    numberOfPeople={careerData[1]}
            ...
            <div>
              ...
              <p style={{ fontFamily: "monospace", fontSize: "1rem" }}>
                Simulation is closed right now.
              </p>
              <i style={{ fontSize: "0.9rem" }}>
                The game could be starting any moment.{" "}
