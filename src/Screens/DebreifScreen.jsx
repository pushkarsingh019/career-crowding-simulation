        ...
        <div className="screen">
            ...
            <div className="explanation">
                <div>
                    ...
                    <br />
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/Woul8Vr-GUw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
                <div>
